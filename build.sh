...
dpkg-deb --build --root-owner-group "$PKG_DIR" "$ROOT_DIR/snaplinux-mp3_2.8-1_all.deb"
echo ""
echo "Listo: snaplinux-mp3_2.8-1_all.deb"
echo "Instálalo con: sudo apt install ./snaplinux-mp3_2.8-1_all.deb"
